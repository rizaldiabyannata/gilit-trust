...
<body class="flex flex-col w-full font-poppins">
    ...
    <div class="mt-32 px-24">
        <p class="mb-1 font-poppins font-semibold text-sm">Search</p>
    ...
    <div class="flex flex-row w-full items-center justify-between px-24 pt-4">
        ...
        <div class="flex flex-col w-[230px] pt-4">
            <button type="submit" class="h-[50px] w-full bg-[#4CB9E0] text-white text-xl font-semibold rounded-xl shadow-xl hover:scale-105 transition-all ease-in-out cursor-pointer">
                Apply
            </button>
        </div>
    ...
    <div class="grid grid-cols-3 justify-items-center pt-12 px-16 gap-y-8">
        <div class="flex flex-col w-[380px] hover:scale-105 transition-all ease-in-out cursor-pointer">
