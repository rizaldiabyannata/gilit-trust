...
<body class="flex flex-col w-full font-poppins">
    <x-navbarMain></x-navbarMain>
        <div class="flex flex-row pt-[120px] w-full items-center space-x-6 justify-between px-24">
            <!-- Dropdown 1 -->
        ...
        <div class="grid grid-cols-3 justify-items-center pt-12 px-12 gap-y-8">
