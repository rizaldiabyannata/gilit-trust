            ...
            <div class="grid grid-cols-3 justify-between gap-4">
                <div class="flex flex-col border rounded-xl w-[290px] hover:scale-105 transition-all ease-in-out cursor-pointer">
                    <div class="relative flex">
                        <div class="flex flex-row absolute px-3 pt-2 justify-between w-full">
                            <div class="flex flex-row justify-center items-center h-[35px] w-[100px] bg-white border rounded-full">
                                <p class="text-[14px] font-semibold pr-1">Rp. 50K/Jam</p>
                            </div>
                            <div class="flex flex-row justify-center items-center h-[35px] w-[100px] bg-white border rounded-full">
                        ...
                        <img src="{{ asset('picture/rentspengusaha.png') }}" class="w-full h-[220px] rounded-t-xl mt-12" alt="">
                    </div>
